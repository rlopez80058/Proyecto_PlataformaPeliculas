        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Popularity = table.Column<decimal>(type: "decimal(10,2)", nullable: false),
                    VoteAverage = table.Column<decimal>(type: "decimal(4,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LibraryItemId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ActivityLogs_LibraryItems_LibraryItemId",
                        column: x => x.LibraryItemId,
                        principalTable: "LibraryItems",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ActivityLogs_Movies_MovieId",
                        column: x => x.MovieId,
                        principalTable: "Movies",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ActivityLogs_LibraryItemId",
                table: "ActivityLogs",
                column: "LibraryItemId");

            migrationBuilder.CreateIndex(
                name: "IX_ActivityLogs_MovieId",
                table: "ActivityLogs",
                column: "MovieId");
